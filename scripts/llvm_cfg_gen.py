...
instr_specs = {
    ...
    "to_ignore" : ["_log_log",  'mm_alloc', 'mm_free', "__acrt_iob_func"]
}
...
notice_str = '// file generated by a ROOT-Sim build script, do not edit\n'
...
if __name__ == '__main__':
    ...
    with open(source_output, 'w') as f:
        ...
        f.write('#include <compiler/rootsim-cc_llvm.hpp>\n\n')
