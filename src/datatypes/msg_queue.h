...
extern struct lp_msg *msg_queue_min(void); 
extern unsigned msg_queue_count(void);
extern void msg_queue_insert(struct lp_msg *msg);
extern void msg_queue_insert_self(struct lp_msg *msg);
extern void msg_queue_destroy_all_input_queues(void);
extern int msg_queue_iterate_over_msg(int (*func)(struct lp_msg*, simtime_t), simtime_t);
