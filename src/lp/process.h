...
enum pes_entry_type {
	/// The message pointed by the PES entry has been received by the LP owning the PES
	PES_ENTRY_RECEIVED = 0U,
	/// The message pointed by the PES entry has been sent in shared memory by the LP which owns this PES
	PES_ENTRY_SENT_LOCAL = 1U,
	/// The message pointed by the PES entry has been sent to another node by the LP which owns this PES
