...
extern bool is_retractable(lp_msg* msg);

inline bool is_retractable_and_valid(lp_msg* msg);
extern bool is_retractable_and_valid(lp_msg* msg);

inline bool is_valid_retractable(lp_msg* msg);
extern bool is_valid_retractable(lp_msg* msg);


extern bool is_retractable_dummy(lp_msg* msg);
