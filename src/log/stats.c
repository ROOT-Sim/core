...
void stats_global_init(void)
{
	...
	stats_tmps = mm_alloc((global_config.n_threads_warp + global_config.n_threads_racer) * sizeof(*stats_tmps));
}
...
static void stats_files_send(void)
{
	...
	for(rid_t i = 0; i < global_config.n_threads_warp + global_config.n_threads_racer; ++i) {
...
void stats_global_fini(void)
{
	...
	stats_glob_cur.threads_count = global_config.n_threads_warp + global_config.n_threads_racer;
